...
import PrescriptionCalculator from "../../../components/calculators/PrescriptionCalculator";
    ...
    <main className="min-h-screen bg-[var(--bg-main)] px-4 py-6 text-[var(--text-dark)] md:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-4 flex items-center justify-between">
          <h1 className="font-fr text-2xl font-bold text-[var(--text-dark)]">Calculateur de prescription</h1>
          <Link
            href="/calculators"
